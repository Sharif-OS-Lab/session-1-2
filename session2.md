...
آدرس فایل:
    ...
    > اگر با خطا مواجه شدید در هنگام اجرای make که به نام `__x64_sys_hello` اشاره داشت. این خط را تغییر دهید و از این نام استفاده کنید و در ردیف قبل ۵۰۰ قرار دهید (برای مثال ۴۶۵) و 64 را با common تعویض کنید
    </div>
