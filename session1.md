...
بعد از کامپایل کردن هسته و نصب  آن برای فعال کردن منوی grub جهت انتخاب کرنل مورد نظر هنگام اجرای سیستم عامل فایل زیر را با استفاده از یک ویرایشگر متن باز کنید:
    <div dir="ltr">
...
مقدار GRUB_TIMEOUT_STYLE را به menu تغییر دهید و مقدار GRUB_TIMEOUT را عددی غیر 0 بگذارید. این متغیر نشان دهنده زمان صبر برای انتخاب شما در منوی grub می باشد. بعد از ذخیره این فایل دستور زیر را اجرا کنید:
    <div dir="ltr">
